...
import ch.ti.csi.corso.batch.BatchConfig;
...
public class ImportProductsIntegrationTest {
	...
	@Test public void importProducts() throws Exception {
		...
		Assert.assertEquals((int)initial+nbOfNewProducts,(int)jdbcTemplate.queryForObject("select count(1) from product", Integer.class));
	}
